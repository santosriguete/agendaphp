...
<html lang="pt-br">
    ...
    <header> 
        ...
        <div class="row justify-content-center row-cols-2 row-cols-md-2 mb-3 text-justify">
            <div class="col">
                <div class="card mb-4 rounded-4 shadow-sw">
                    <div class="card-header py-3 text-center">
                        <h4 class="my-0 fw-nomral"><b>Confirmação de Cadastro</b><h4>                    
                    </div> 
                    <div class="card-body">
                        <?php
                            echo "<b>Nome:</br>".$dados['nome']."<br/>";
                            echo "<b>Celular:</br>".$dados['celular']."<br/>";
                            echo "<b>E-mail:</br>".$dados['email']."<br/>";
                        ?>
                        <br/><br/>
